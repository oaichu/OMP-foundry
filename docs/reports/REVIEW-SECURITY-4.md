...
| Hermetic test suite | PASS | `tests/index-integration.test.ts:558-670` & `tests/security-runner.test.ts:1152-1397`: Complete test defense for gitignore narrowing, command dispatch, and release gating (fresh, stale, partial, blocked, missing tool). |
